(function(doc) {
  ...
  for (let modal of modals) {
    ...
    modal.addEventListener('click', function(){ buildBtnsModal(event) } )
    modal.addEventListener('touchstart', function(){ buildBtnsModal(event) } )
  }

  function buildCollaborationModal() {
  ...
  openCollaboration.addEventListener('click', buildCollaborationModal)
  openCollaboration.addEventListener('touchstart', buildCollaborationModal)

  function buildModelPlatform() {
  ...
  openModelPlatform.addEventListener('click', buildModelPlatform)
  openModelPlatform.addEventListener('touchstart', buildModelPlatform)
